    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ملاحظة النسخة
          _buildSectionHeader(context, 'حول هذه النسخة', LucideIcons.info),
          const SizedBox(height: 8),
          _buildCard(
            context,
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'هذه النسخة خاصة بالنماذج المحلية من Build X',
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'ولا يُعد هذا التطبيق هو Build X الأصلي، إنما نسخة مخصصة للنماذج المحلية فقط.',
